...
public class IntergalacticItem extends SammymodModElements.ModElement {
	@ObjectHolder("sammymod:intergalactic")
	public static final Item block = null;
	public IntergalacticItem(SammymodModElements instance) {
		super(instance, 2);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, SammymodModElements.sounds.get(new ResourceLocation("sammymod:intergalactic")),
					new Item.Properties().group(SammyNightsTabItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("intergalactic");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Intergalactic - Beastie Boys"));
		}
