...
package net.mcreator.sammymod.entity;
...
public class SammyNightsEntity extends SammymodModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(SammyNightsTabItemGroup.tab))
				.setRegistryName("sammy_nights_spawn_egg"));
	}
